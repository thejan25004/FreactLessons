...
export { ConnectedPayload, CustomPayload, ErrorPayload, FullReloadPayload, HMRPayload, PrunePayload, Update, UpdatePayload } from 'vvite/types/hmrPayload.js
import { InferCustomEventPayload } from 'vivite/types/customEvent.jsexport { CustomEventMap, InferCustomEventPayload, InvalidatePayload } from 'vitvite/types/customEvent.jsmport { TransformOptions as esbuild_TransformOptions, TransformResult as esbuild_TransformResult, BuildOptions as esbuild_BuildOptions } from 'esbuild';
...
export { GeneralImportGlobOptions, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from 'vitevite/types/importGlob.jsport { ChunkMetadata } from 'vite/vite/types/metadata.jsort 'vite/tvite/types/hot.jserface Alias {
  find: string | RegExp
  replacement: string
  /**
